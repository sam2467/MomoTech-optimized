...
public class UGenerator extends AbstractElectricGUI implements RecipeDisplayItem {
    public UGenerator(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
